 ...
 * entries as well.
 *
 * A device scans if its TXT record carries "rs", the resource path of
 * its scan service (PWG 5100.17, section 10).
 */
typedef struct ipp_device {
    ...
    char     *model;                               /* TXT "ty" */
    char     *uuid;                                /* TXT "uuid" */
    char     *rp;                                  /* TXT "rp", print resource */
    char     *rs;                                  /* TXT "rs", scan resource */
    char     *pdl;                                 /* TXT "pdl" */
 ...
 * its brackets. A NULL rp yields the default print resource. The
 * result is to be released with free().
 */
char*
